...
- [ ] **Cary's pin/flag not showing on family map.** Was fixed in v1.30.3, may have regressed. Investigate whether assigned caregiver pins are still rendering on the family-side Caregivers map. *(Feedback — Pete, Feb 25)* **P1**
- [ ] **Sara's avatar shows initials instead of uploaded photo.** Profile photo not rendering for Sara — check if photo is saved in DB and whether the contacts/conversations query returns it. *(Feedback — Pete, Feb 25)* **P1**
- [ ] **Splash page: clarify spring 2026 launch and VA-only.** Make it clear on the splash page that InPlace isn't launching until spring 2026 and will start in Virginia. *(Feedback — Pete, Feb 25)* **P2**
...
- [ ] **Activity feed: show specific user names.** "Sara joined." "Peter cancelled appointment." "Cary was paid via instant." More detail than generic "Family cancelled session." *(Feedback — Pete, Feb 25)* **P2**
...
- [ ] **Group chat icon: overlapping avatars with care recipient on top.** Replace generic group icon with stacked/overlapping member avatars, care recipient photo on top. *(Feedback — Pete, Feb 25)* **P2**
