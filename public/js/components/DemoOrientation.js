...
const DemoOrientation = window.DemoOrientation = ({ onAcknowledge }) => {
  ...
  const points = [
    ...
    },
    {
      ...
      body: `They are not our employees. They set their own hours and their own rates, and accept or decline any request. Caregivers keep their full rate; InPlace adds ${feePercent}% on top for the family.`,
    },
    {
      icon: '🩺',
